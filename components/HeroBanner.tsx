      ...
      <div className="absolute inset-0">
        {slides.map((s, i) =>
          s.type === "catalog" ? (
            ...
            <div
              key={`e-${s.ev.id}`}
              className={`absolute inset-0 transition-opacity duration-[1200ms] ease-out bg-gradient-to-br from-brand/40 via-surface to-black ${
        ...
        <div
          className={`absolute inset-0 bg-gradient-to-br from-brand/30 to-surface transition-opacity duration-700 ${
