...
export default function MyListPage() {
  ...
  return (
    <div className="pt-12 min-h-screen pb-20 animate-fade-in">
      <div className="px-4 mb-3 flex items-center gap-2">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-brand to-red-700 flex items-center justify-center">
